...
#ifndef _WIDGET_VISIOR_QSlider_HPP_INCLUDED
#define _WIDGET_VISIOR_QSlider_HPP_INCLUDED
#include "WidgetVisitorObject.hpp"
#include <QSlider>

class WidgetVisitorState_QSlider
	:public WidgetVisitorObject
{
public:
	WidgetVisitorState_QSlider( QWidget* widget_);
