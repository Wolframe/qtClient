...
#ifndef _WIDGET_VISIOR_QTimeEdit_HPP_INCLUDED
#define _WIDGET_VISIOR_QTimeEdit_HPP_INCLUDED
#include "WidgetVisitorObject.hpp"
#include <QTimeEdit>

class WidgetVisitorState_QTimeEdit
	:public WidgetVisitorObject
{
public:
	WidgetVisitorState_QTimeEdit( QWidget* widget_);
