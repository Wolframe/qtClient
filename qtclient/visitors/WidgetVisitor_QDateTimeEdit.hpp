...
#ifndef _WIDGET_VISIOR_QDateTimeEdit_HPP_INCLUDED
#define _WIDGET_VISIOR_QDateTimeEdit_HPP_INCLUDED
#include "WidgetVisitorObject.hpp"
#include <QDateTimeEdit>

class WidgetVisitorState_QDateTimeEdit
	:public WidgetVisitorObject
{
public:
	WidgetVisitorState_QDateTimeEdit( QWidget* widget_);
