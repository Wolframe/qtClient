...
#ifndef _WIDGET_VISIOR_QStackedWidget_HPP_INCLUDED
#define _WIDGET_VISIOR_QStackedWidget_HPP_INCLUDED
#include "WidgetVisitorObject.hpp"
#include <QStackedWidget>

class WidgetVisitorState_QStackedWidget
	:public WidgetVisitorObject
{
public:
	WidgetVisitorState_QStackedWidget( QWidget* widget_);
