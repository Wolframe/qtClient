...
#ifndef _WIDGET_VISIOR_QSpinBox_HPP_INCLUDED
#define _WIDGET_VISIOR_QSpinBox_HPP_INCLUDED
#include "WidgetVisitorObject.hpp"
#include <QSpinBox>

class WidgetVisitorState_QSpinBox
	:public WidgetVisitorObject
{
public:
	WidgetVisitorState_QSpinBox( QWidget* widget_);
