...
#ifndef _WIDGET_VISIOR_QDateEdit_HPP_INCLUDED
#define _WIDGET_VISIOR_QDateEdit_HPP_INCLUDED
#include "WidgetVisitorObject.hpp"
#include <QDateEdit>

class WidgetVisitorState_QDateEdit
	:public WidgetVisitorObject
{
public:
	WidgetVisitorState_QDateEdit( QWidget* widget_);
