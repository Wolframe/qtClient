...
#include "FormLoader.hpp"
	...
	class FileFormLoader : public FormLoader
	{
		...
		public:
			FileFormLoader( QString formDir, QString localeDir, QString resourcesDir, QString menusDir );
			...
			virtual void initiateMenuListLoad( );
			virtual void initiateMenuLoad( QString &name );
